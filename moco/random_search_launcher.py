...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--causal", action="store_true", default=DEFAULT_FIXED_ARGS["causal"])
    p.add_argument("--baseline", type=str, default=DEFAULT_FIXED_ARGS["baseline"])
    p.add_argument("--reward_shaping", type=str, default=DEFAULT_FIXED_ARGS["reward_shaping"])
    p.add_argument("--aggregation", type=str, default=DEFAULT_FIXED_ARGS["aggregation"])
    p.add_argument("--normalization", type=str, default=DEFAULT_FIXED_ARGS["normalization"])
